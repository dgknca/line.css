    ...
    <div class="doc-table">
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              <code>--disabled-thumb-border-color</code>
            </td>
            <td>
              <code>var(--gray)</code>
            </td>
...
<script>
import { rangeMixin } from './../snippets/range'
export default {
  mixins: [rangeMixin]
}
</script>
